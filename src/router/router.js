...
export const locking = {
    path: '/locking',
    name: 'locking',
    component: () => import('@/views/main/lockscreen/components/locking-page.vue')
}
        ...
        children: [
            {
                ...
                name: 'qpic_index',
                icon: 'key',
                component: () => import('@/views/qpic/qpic.vue')
            }
        ]
    },
    {
    ...
    },*/
    {
        ...
        children: [
            ...
            },
            {
                ...
                icon: 'images1',
                component: () => import('@/views/tables/components/canEditTable.vue')
            }
        ]
    },
    {
